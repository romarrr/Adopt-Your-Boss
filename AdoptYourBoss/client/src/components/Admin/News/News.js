...
const News = (props) => 
{
    ...
    function delNews(id)
    {
        ...
        axios.get(`http://localhost:5000/news/delete/${id}`);
    }

    function upNew(id)
    {
        history.push("/admin/News/form/"+id)
        ...
        <div class="row mx-0" style={{marginTop: "150px"}}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                                ...
                                <input onChange={handleSearchTerm} type="text" class="form-control" placeholder="Recherchez" aria-label="Input group example" aria-describedby="basic-addon1"/>
                                    ...
                                    <button class="btn btn-warning" onClick={()=>history.push('/admin/news/form')} >Ajouter une nouvelle News</button>
                    </div>
            ...
            }return recherche.toLowerCase().includes(searchTerm)}).map((value, index)=>
            {
                ...
                const submita = (e) => {
                    confirmAlert({
                      title: 'Suppression',
                      message: 'Etes-vous sur de vouloir supprimer cette news ?',
                      buttons: [
                        {
                          label: 'Oui',
                          onClick: (e)=>delNews(value._id)
                        },
                        {
                          label: 'Non',
                        }
