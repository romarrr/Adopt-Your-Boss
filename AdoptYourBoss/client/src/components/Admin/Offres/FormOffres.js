...
const FormOffres = () => {
	...
	function submit(e){
		...
		.then(res =>{
			...
			window.location.replace("http://localhost:3000/admin/Offres")
		})
	}
...
<fieldset class="mt-5">
<h1 class="text-light text-center">Ajouter <span class="text-warning">une</span> offre</h1>
	<form class="mx-5" onSubmit={(e) => submit(e)} action='./admin/'>
		...
		<label for="titre" class="mt-4 text-light mb-2">Metier :</label>			
			...
			<button variant="contained" type="submit" class="my-5 btn btn-warning btn-block">Ajouter l'offre</button>
